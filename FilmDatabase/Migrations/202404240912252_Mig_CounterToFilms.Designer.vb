...
Public NotInheritable Partial Class Mig_CounterToFilms
    Implements IMigrationMetadata

    Private ReadOnly Resources As New ResourceManager(GetType(Mig_CounterToFilms))
    
    Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
        Get
            Return "202404240912252_Mig_CounterToFilms"
        End Get
    End Property
